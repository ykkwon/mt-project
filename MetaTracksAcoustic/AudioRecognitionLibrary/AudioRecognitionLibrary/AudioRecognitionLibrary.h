...
//! Project version number for AudioRecognitionLibrary.
FOUNDATION_EXPORT double AudioRecognitionLibraryVersionNumber;

//! Project version string for AudioRecognitionLibrary.
FOUNDATION_EXPORT const unsigned char AudioRecognitionLibraryVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <AudioRecognitionLibrary/PublicHeader.h>
