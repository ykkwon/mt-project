...
using System.Linq;
using iOSApplication.SoundFingerprint.AudioProxies;
using iOSApplication.SoundFingerprint.AudioProxies.Strides;
using iOSApplication.SoundFingerprint.FFT;
using iOSApplication.SoundFingerprint.Wavelets;
using iOSApplication.SoundFingerprint.Windows;

namespace iOSApplication.SoundFingerprint
{
